-- Simulation 0.0.3 Implements SimLua Processes, Resources, Buffers, and the backbone
...
function simulate(etime)
    ...
    while not stop and t <= endtime do
        ...
        if command == "hold" then e:push(a, t+delta)
        elseif coommand == "passivate" then Nada("passivate")
        elseif command == "request" then Nada("request")
        elseif command == "release" then Nada("release")
        elseif command == "waitevent" then Nada("waitevent")
        elseif command == "queueevent" then Nada("queueevent")
        elseif command == "waituntil" then Nada("waituntil")
        elseif command == "get" then Nada("get")
        elseif command == "put" then Nada("put")
        else error("Fatal Error: Invalid command")
